...
<template>
    <div>
      ...
      <div :style='{"height":maxHei}' style='overflow: auto' >
        ...
        <form-preview v-if='list.length>0'  header-label="申请金额" header-value="¥2000" :body-items="list"  name="demo" class='formClass'></form-preview>
        <div @click='showTipFun' v-if='list.length>0'  class="btn" data-clipboard-text="18771186061" data-clipboard-action="copy" style='text-align: center;color:#0BB20C;line-height: 50px; '>还款</div>
